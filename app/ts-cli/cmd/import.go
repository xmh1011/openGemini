...
func init() {
	...
	importCmd.Flags().StringVar(&options.Host, "host", DEFAULT_HOST, "openGemini host to connect to.")
	importCmd.Flags().IntVar(&options.Port, "port", DEFAULT_PORT, "openGemini port to connect to.")
	...
	importCmd.Flags().StringVar(&options.Precision, "precision", "ns", "Precision specifies the format of the timestamp:  rfc3339,h,m,s,ms,u or ns.")
...
var importCmd = &cobra.Command{
	...
	Long:  `Import a previous database export from file.`,
