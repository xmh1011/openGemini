	...
	tests["config_command"] = Test{
		...
		queries: []*Query{
			&Query{
				...
				skip:    true,
				exp:     `{"results":[{"statement_id":0,"series":[{"columns":["component","instance","name","value"],"values":[["sql",":127.0.0.1:8086","logging.level","info"],["sql",":127.0.0.1:8086","logging.format","auto"],["sql",":127.0.0.1:8086","logging.max-size",67108864],["sql",":127.0.0.1:8086","logging.max-num",16],["sql",":127.0.0.1:8086","logging.max-age",7],["sql",":127.0.0.1:8086","logging.compress-enabled",true],["sql",":127.0.0.1:8086","logging.path","/tmp/openGemini/logs/"],["sql",":127.0.0.1:8086","meta-join",["127.0.0.1:8092"]],["sql",":127.0.0.1:8086","ignore-empty-tag",false],["sql",":127.0.0.1:8086","report-enable",true],["sql",":127.0.0.1:8086","crypto-config",""],["sql",":127.0.0.1:8086","cluster-id",""],["sql",":127.0.0.1:8086","cpu-num",0],["sql",":127.0.0.1:8086","read-stop",false],["sql",":127.0.0.1:8086","write-stop",false],["sql",":127.0.0.1:8086","write-timeout","10s"],["sql",":127.0.0.1:8086","memory-size",0],["sql",":127.0.0.1:8086","executor-memory-size-limit",0],["sql",":127.0.0.1:8086","executor-memory-wait-time","0s"],["sql",":127.0.0.1:8086","max-query-mem",0],["sql",":127.0.0.1:8086","select-hash-algorithm","ver03"],["sql",":127.0.0.1:8086","cpu-allocation-ratio",1],["sql",":127.0.0.1:8086","ha-policy","write-available-first"],["sql",":127.0.0.1:8086","max-concurrent-queries",0],["sql",":127.0.0.1:8086","query-timeout","0s"],["sql",":127.0.0.1:8086","query-limit-interval-time",10],["sql",":127.0.0.1:8086","query-limit-level",0],["sql",":127.0.0.1:8086","query-limit-flag",false],["sql",":127.0.0.1:8086","query-time-compare-enabled",true],["sql",":127.0.0.1:8086","continuous-query-enabled",false],["sql",":127.0.0.1:8086","continuous-query-run-interval","1s"],["sql",":127.0.0.1:8086","continuous-query-max-process-CQ-number",2],["sql",":127.0.0.1:8086","force-broadcast-query",false],["sql",":127.0.0.1:8086","log-queries-after","0s"],["sql",":127.0.0.1:8086","shard-writer-timeout","10s"],["sql",":127.0.0.1:8086","shard-mapper-timeout","10s"],["sql",":127.0.0.1:8086","shard-tier","warm"],["sql",":127.0.0.1:8086","meta-executor-write-timeout","5s"],["sql",":127.0.0.1:8086","rp-limit",100],["sql",":127.0.0.1:8086","time-range-limit",null],["sql",":127.0.0.1:8086","tag-limit",0],["sql",":127.0.0.1:8086","byte-buffer-pool-default-size",0],["sql",":127.0.0.1:8086","recv-window-size",0],["sql",":127.0.0.1:8086","concurrent-accept-session",0],["sql",":127.0.0.1:8086","conn-pool-size",0],["sql",":127.0.0.1:8086","open-session-timeout","0s"],["sql",":127.0.0.1:8086","session-select-timeout","0s"],["sql",":127.0.0.1:8086","tcp-dial-timeout","0s"],["sql",":127.0.0.1:8086","data-ack-timeout","0s"],["sql",":127.0.0.1:8086","compress-enable",false],["sql",":127.0.0.1:8086","tls-enable",false],["sql",":127.0.0.1:8086","tls-client-auth",false],["sql",":127.0.0.1:8086","tls-insecure-skip-verify",false],["sql",":127.0.0.1:8086","tls-certificate",""],["sql",":127.0.0.1:8086","tls-private-key",""],["sql",":127.0.0.1:8086","tls-client-certificate",""],["sql",":127.0.0.1:8086","tls-client-private-key",""],["sql",":127.0.0.1:8086","tls-ca-root",""],["sql",":127.0.0.1:8086","tls-server-name",""],["sql",":127.0.0.1:8086","http-flight-address",":8087"],["sql",":127.0.0.1:8086","http-flight-enabled",false],["sql",":127.0.0.1:8086","http-flight-auth-enabled",false],["sql",":127.0.0.1:8086","http-flight-ch-factor",2],["sql",":127.0.0.1:8086","http-domain",""],["sql",":127.0.0.1:8086","http-auth-enabled",false],["sql",":127.0.0.1:8086","http-weakpwd-path",""],["sql",":127.0.0.1:8086","http-log-enabled",true],["sql",":127.0.0.1:8086","http-suppress-write-log",false],["sql",":127.0.0.1:8086","http-write-tracing",false],["sql",":127.0.0.1:8086","http-flux-enabled",false],["sql",":127.0.0.1:8086","http-flux-log-enabled",false],["sql",":127.0.0.1:8086","http-pprof-enabled",true],["sql",":127.0.0.1:8086","http-debug-pprof-enabled",false],["sql",":127.0.0.1:8086","https-enabled",false],["sql",":127.0.0.1:8086","https-certificate","/etc/ssl/influxdb.pem"],["sql",":127.0.0.1:8086","https-private-key",""],["sql",":127.0.0.1:8086","http-max-row-limit",1000000],["sql",":127.0.0.1:8086","http-max-connection-limit",1000],["sql",":127.0.0.1:8086","http-shared-secret",""],["sql",":127.0.0.1:8086","http-realm","InfluxDB"],["sql",":127.0.0.1:8086","http-unix-socket-enabled",false],["sql",":127.0.0.1:8086","http-unix-socket-group",null],["sql",":127.0.0.1:8086","http-unix-socket-permissions","0777"],["sql",":127.0.0.1:8086","http-bind-socket","/var/run/tssql.sock"],["sql",":127.0.0.1:8086","http-max-body-size",25000000],["sql",":127.0.0.1:8086","http-access-log-path",""],["sql",":127.0.0.1:8086","http-access-log-status-filters",null],["sql",":127.0.0.1:8086","http-max-concurrent-write-limit",32],["sql",":127.0.0.1:8086","http-max-enqueued-write-limit",968],["sql",":127.0.0.1:8086","http-max-concurrent-query-limit",8],["sql",":127.0.0.1:8086","http-max-enqueued-query-limit",992],["sql",":127.0.0.1:8086","http-query-request-rate-limit",0],["sql",":127.0.0.1:8086","http-write-request-rate-limit",0],["sql",":127.0.0.1:8086","http-enqueued-query-timeout","5m0s"],["sql",":127.0.0.1:8086","http-white_list",""],["sql",":127.0.0.1:8086","http-slow-query-time","10s"],["sql",":127.0.0.1:8086","http-parallel-query-in-batch-enabled",true],["sql",":127.0.0.1:8086","http-query-memory-limit-enabled",true],["sql",":127.0.0.1:8086","http-chunk-reader-parallel",8],["sql",":127.0.0.1:8086","http-read-block-size",65536],["sql",":127.0.0.1:8086","http-time-filter-protection",false],["sql",":127.0.0.1:8086","subscriber-enabled",false],["sql",":127.0.0.1:8086","subscriber-http-timeout","30s"],["sql",":127.0.0.1:8086","subscriber-insecure-skip-verify",false],["sql",":127.0.0.1:8086","subscriber-https-certificate",""],["sql",":127.0.0.1:8086","subscriber-write-buffer-size",100],["sql",":127.0.0.1:8086","subscriber-write-concurrency",16]]}]}]}`,
			},
			&Query{
				name:    "set config",
